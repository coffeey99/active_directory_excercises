...
### Einrichtung einer IKEv2-Infrastruktur / *Setting up an IKEv2 infrastructure*
...
### Erstellen von OU und Gruppen / *Creating OUs and groups*
...
<img width="700" height="169" alt="image" src="https://github.com/user-attachments/assets/8cb3651f-4975-4b3e-9251-6cbeca950904"  />

<img width="700" height="560" alt="image" src="https://github.com/user-attachments/assets/29973221-5b94-45bb-963e-7808732ff5fe"  />

<img width="539" height="470" alt="image" src="https://github.com/user-attachments/assets/10cd62cc-80e1-40fc-8bf0-5e8c0783acea" />

<img width="700" height="414" alt="image" src="https://github.com/user-attachments/assets/8de49c6b-4f43-4332-8103-3102f827d33e"  />
...
<img width="700" height="353" alt="image" src="https://github.com/user-attachments/assets/1233aaa5-2f64-4714-a2b2-7835e1350e11"  />

Mitglieder hinzufügen:  
*add member:*

<img width="700" height="452" alt="image" src="https://github.com/user-attachments/assets/c91bd459-f314-4f68-ae1c-87dbc0e092e0"  />
...
### Konfiguration des VPN-Servers als CDP- und AIA-Verteilungspunkt / *Configuring the VPN server as a CDP and AIA distribution point*
...
<img width="700" height="384" alt="image" src="https://github.com/user-attachments/assets/cfe3acab-9e6d-4455-9a87-5d821cc2de03"  />

<img width="609" height="649" alt="image" src="https://github.com/user-attachments/assets/9a40cd3a-e44f-4455-b2de-2abf62ca58c5" />

<img width="700" height="800" alt="image" src="https://github.com/user-attachments/assets/0dff6aab-9140-400e-bed4-3f595e3490cd"  />
...
<img width="700" height="308" alt="image" src="https://github.com/user-attachments/assets/c56908af-255c-4731-a18a-21ee26390713"  />

> **💡 Hinweis:** In bestimmten Szenarien, z. B. bei der Verwendung von Zertifikatsdaten in URLs, müssen diese  manchmal doppelt maskiert (escaped) übertragen werden, weshalb in IIS die Option „allowDoubleEscaping“ aktiviert werden muss,  damit solche URLs nicht aus Sicherheitsgründen blockiert werden.
>
> *In certain scenarios, for example when using certificate data in URLs, these sometimes need to be transmitted with double escaping. Therefore, in IIS the option "allowDoubleEscaping" must be enabled so that such URLs are not blocked for security reasons.*

### Konfiguration der Freigabe Certs / *Configuring the release certs*
...
>
> *Note: A CRL is a list of revoked certificates published by the certification authority to check their validity.*
...
### Konfiguration der Firewall auf „Server2“ / *Configuring the firewall on “Server2”*
...
<img width="700" height="190" alt="image" src="https://github.com/user-attachments/assets/f5867f6c-943a-40d5-a21c-313016e5fa48"  />

<img width="700" height="670" alt="image" src="https://github.com/user-attachments/assets/cfc24c81-ba0d-4fbf-9037-51ba81768152"  />

<img width="700" height="657" alt="image" src="https://github.com/user-attachments/assets/1c57cc0e-d0bc-415d-a470-077a539ddd5a"  />

<img width="700" height="569" alt="image" src="https://github.com/user-attachments/assets/50ee7567-81bc-4052-94bd-cae2dfb62e13"  />

<img width="700" height="569" alt="image" src="https://github.com/user-attachments/assets/3503ce2a-a402-442e-ad59-eb45fd31ae33"  />

<img width="700" height="569" alt="image" src="https://github.com/user-attachments/assets/8f361530-4c38-41bc-b4da-12cc344cb4dd"  />
...
### Konfiguration des Paketfilters auf „Server2“ / *Configuring the packet filter on “Server2”*

**Server2 → Server-Manager → Tools → Routing und RAS:**  
*Server2 → Server Manager → Tools → Routing and RAS:*

<img width="700" height="589" alt="image" src="https://github.com/user-attachments/assets/199fb4d2-5b38-43b4-b23a-eb23932a4af4"  />
...
### Konfiguration der Zertifizierungsstelle auf „DC“ / *Configuration of the certification authority on “DC”*

DC → Powershell-ISE Administrator:

<img width="700" height="222" alt="image" src="https://github.com/user-attachments/assets/59477cb8-1363-41f1-b8fd-c666f7109c8d"  />
...
> *The script installs and configures an enterprise root certification authority (CA) in an Active Directory environment with the specified settings.*
...
<img width="700" height="357" alt="image" src="https://github.com/user-attachments/assets/513affc4-dc7f-4172-9c79-41442d8a9247"  />

<img width="700" height="327" alt="image" src="https://github.com/user-attachments/assets/b6bc2c7d-af83-4f09-a8af-50305809dc99"  />

<img width="700" height="355" alt="image" src="https://github.com/user-attachments/assets/3b2ab374-62ad-4866-8ea3-25d9f5bc3914"  />
...
<img width="700" height="219" alt="image" src="https://github.com/user-attachments/assets/83a1c2f6-9c3a-4ecc-a29c-a44b4081c8cf"  />

### Konfiguration der Gruppenrichtlinie zur automatischen Zertifikatsanforderung / *Configuring the group policy for automatic certificate requests*
...
<img width="700" height="467" alt="image" src="https://github.com/user-attachments/assets/6e2b4126-cfb6-45e5-9048-82b49fe5c505"  />
...
<img width="700" height="469" alt="image" src="https://github.com/user-attachments/assets/36ee3767-3526-4c39-8681-d2dd9a9698e0"  />
...
### Konfiguration der Zertifikate - Konfiguration für Clientcomputer IPSEC-Zertifikate / *Configuring Certificates - Configuration for Client Computers IPSEC Certificates*

**DC → Server-Manager → Tools → Gruppenrichtlinienverwaltung:**  
*DC → Server Manager → Tools → Group Policy Management:*

<img width="700" height="467" alt="image" src="https://github.com/user-attachments/assets/b42667f6-3abe-4d86-b13e-1f6015a7d6db"  />

<img width="476" height="222" alt="image" src="https://github.com/user-attachments/assets/01727212-d4f4-4507-ad12-670d019b1e31" />

<img width="700" height="348" alt="image" src="https://github.com/user-attachments/assets/00d16983-04b8-4588-9aca-dde1f4548f0d"  />

<img width="700" height="772" alt="image" src="https://github.com/user-attachments/assets/7153c765-01e3-4e9c-a8be-db912e8b0bf9"  />

<img width="700" height="475" alt="image" src="https://github.com/user-attachments/assets/3a55c84d-5ec4-43f1-aab9-bd0638f30be8"  />
...
<img width="700" height="647" alt="image" src="https://github.com/user-attachments/assets/cb39909b-1fe7-4b15-aa42-1e61e899bfe2"  />

<img width="700" height="655" alt="image" src="https://github.com/user-attachments/assets/fe7029c9-ce33-4756-95e6-952ff4f9c045"  />
...
<img width="700" height="381" alt="image" src="https://github.com/user-attachments/assets/77e34003-ad3b-4c24-b4ba-bea4a563c7ae"  />

<img width="700" height="440" alt="image" src="https://github.com/user-attachments/assets/b043bdb1-8a15-42a7-9e54-a77bb1b664d2"  />

**W11:**

<img width="700" height="415" alt="image" src="https://github.com/user-attachments/assets/543c50bc-ed61-4e3f-b02f-2ccaf8976bc4"  />

<img width="556" height="695" alt="image" src="https://github.com/user-attachments/assets/adb9759f-1f36-41d8-b3a3-dca4db11bca3" />

**CMD:**

<img width="700" height="163" alt="image" src="https://github.com/user-attachments/assets/a46748a0-d4bb-4b9c-b040-5dda7991e135"  />

```powershell
gpupdate /force
```

<img width="700" height="102" alt="image" src="https://github.com/user-attachments/assets/8c31c63f-72f8-4175-9d08-af8b45e28c13"  />
...
> *If you receive the following error message when running “gpupdate /force”, execute the script “NOTFALL_Sysvol_fix.ps1” on the ‘DC’. The file is located on GFN-RLAB under the path C:\ISOs\Tools\NOTFALL_Sysvol_fix.ps1".*

<img width="700" height="140" alt="image" src="https://github.com/user-attachments/assets/d7b9267a-0cb3-4a2f-b578-38661095d1b0"  />

<img width="700" height="58" alt="image" src="https://github.com/user-attachments/assets/8bb875e9-df84-4b35-b4e2-4aeab27a40c7"  />
...
<img width="700" height="137" alt="image" src="https://github.com/user-attachments/assets/b9134323-cb05-45bf-8564-ae99d13b3dfc"  />

<img width="700" height="309" alt="image" src="https://github.com/user-attachments/assets/4058f1ed-3089-4b34-a693-d05c2d7818e6"  />

### Erstellen der Zertifikatsvorlage für die VPN-User / *Creating the certificate template for VPN users*

**DC → Server-Manager → Tools → Zertifizierungsstelle**  
*DC → Server Manager → Tools → Certification Authority*

<img width="700" height="359" alt="image" src="https://github.com/user-attachments/assets/dd3618bb-44a8-45d4-ba4e-dad969188d20"  />

<img width="700" height="384" alt="image" src="https://github.com/user-attachments/assets/751a78ac-2b75-4db4-b03c-c53bc580f54e"  />

<img width="517" height="691" alt="image" src="https://github.com/user-attachments/assets/dda2f210-5365-4606-be5f-dd9861428475" />

<img width="700" height="438" alt="image" src="https://github.com/user-attachments/assets/5f87a155-22ff-4d9d-a5ac-0abec1f55d46"  />
...
<img width="700" height="376" alt="image" src="https://github.com/user-attachments/assets/e3c263eb-20ed-4a2e-ad5d-82ab46224c3e"  />

<img width="700" height="448" alt="image" src="https://github.com/user-attachments/assets/de2c1f7a-5583-4af0-bec4-064152e065de"  />
...
<img width="700" height="198" alt="image" src="https://github.com/user-attachments/assets/2c249e6d-62c8-4df7-b35c-8dfedc63dbde"  />

```powershell
gpresult /r
```

<img width="700" height="314" alt="image" src="https://github.com/user-attachments/assets/8d95960e-4583-4a89-977e-c79fe87739d3"  />

<img width="700" height="560" alt="image" src="https://github.com/user-attachments/assets/169f4430-67e6-4938-b235-eaffa4b908b8"  />
...
### Erstellen der Zertifikatsvorlage für NPS-Server / *Creating the certificate template for NPS servers*
...
<img width="700" height="371" alt="image" src="https://github.com/user-attachments/assets/1288a71d-e1fd-4f9c-abda-72d982426852"  />
...
<img width="700" height="449" alt="image" src="https://github.com/user-attachments/assets/0e42f2e0-4994-4739-a1fc-5856d1497d3f"  />
...
<img width="700" height="399" alt="image" src="https://github.com/user-attachments/assets/c7d0c1c4-1d12-49eb-b2a5-9b34a9454cfc"  />
...
<img width="700" height="300" alt="image" src="https://github.com/user-attachments/assets/e5b89ea4-f96d-4f84-926f-397a339ad394"  />

<img width="700" height="491" alt="image" src="https://github.com/user-attachments/assets/8f340b92-2b74-464e-907a-b2fdb920600f"  />

